window.onload = function () {
  ...
  function play_winning_sound() {
    ...
    sound.setAttribute('src', './assets/images/Lostmusic.mp3');
  ...
  function play_losing_sound() {
    var sound = document.createElement("audio");
    sound.src = "./assets/images/Evillaugh.mp3";
    //sound.setAttribute('src', './assets/images/Evillaugh.mp3');
    //sound.style.display = 'none';
    //document.body.appendChild(sound);
    sound.play();
    //setTimeout(function () {
